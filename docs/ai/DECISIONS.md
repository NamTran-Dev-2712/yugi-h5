...
- **Thời lượng (ms, `DURATION_MS`)**: draw 250 (gộp nhiều lá 600) · summon 400 · set 300 · tribute 350 · flip 400 · position 300 · attack 500 · destroy 450 · damage 600 · discard 300 · phase 250 · turn 400 · duelEnd 500 · aiLabel 250. Ngắn hơn `notes/animation-durations.md` (Summon ~2.6 s, Tribute ~2.2 s, attack ~0.7 s, banner lượt ~1.7 s, rút đối thủ ~1.3–1.8 s) 2–5× để chơi thử nhanh; Set/Flip/đổi thế chưa có footage `[GUESS]`. **Chờ chủ dự án chốt**; đổi ở một bảng + `setSpeed`.
