...
- **Task tiếp theo: 2.2** (DuelService bọc `applyAction` + phiên duel), rồi 2.3; nên có task lọc event (`GameEvent` theo viewer) trước khi phát event ra client. Review P1 vẫn cần người duyệt.
