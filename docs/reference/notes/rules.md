...
| --- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| C1  | Game có **Link monster** (thẻ "LINK n") và **2 ô "EX"** giữa bàn (giống Extra Monster Zone của Master Rule 5) | G8: chưa Link; luật cổ điển, không EMZ (`zones`) | Đây không phải "early Master Rule". Cân nhắc: giữ v1 như cũ (Link/EX sau) **hoặc** đưa EX zone + Link vào kế hoạch. Hiện state chỉ có 5 ô quái |
| C2  | **LP người chơi = 10000** ở cả 2 ván (đối thủ 10000 và 8000)                                                  | `startingLP` 8000 `[RULE]/[GUESS]`               | Đổi mặc định 10000? và cho phép LP **khác nhau mỗi bên** (config hiện 1 giá trị)                                                               |
| C3  | Extra Deck hiển thị **20/20**                                                                                 | `extraDeckSize` = 15 (bạn vừa chốt)              | Đổi 20? (không đổi khi chưa có lệnh)                                                                                                           |
| C4  | Không thấy **thanh phase**; chỉ 1 nút "Kết thúc"/"Công"                                                       | `ui-plan.md`: phase bar Draw→End                 | Cân nhắc: UI đơn giản hoá (1 nút); engine vẫn giữ phase                                                                                        |
