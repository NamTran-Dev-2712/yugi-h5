...
| G13 | Chính sách AI đối thủ (Summon/Set/tribute/tấn công); ngưỡng 1800 / margin 300       | [GUESS]                                       | `apps/api/src/modules/duels/ai/ai-config.ts`; Yugi H5 gốc không có tư liệu về AI, đổi khi có                                                        |
