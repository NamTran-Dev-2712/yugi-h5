...
| Ẩn thông tin theo viewer (StateView)   | [RULE]/thiết kế bảo mật                  | 🟨         | task 2.1 + event-filter + 2.3 (nháp): view/event lọc theo ghế, e2e HTTP 1 ván không lộ; Spell/Trap úp fail-closed `[ASSUMED]`; chưa fuzz. Task 2.5 (nháp): `legalActions` chỉ id/ô, không `definitionId`, e2e quét rò rỉ |
...
| Win / lose + Surrender                 | [RULE]/[DECISION]                        | 🟨         | LP về 0: task 1.7 (nháp); Surrender: task 1.9 (nháp, có `allowSurrender`); deck-out: task 1.10 (nháp); hand limit chưa làm, G11                                                                                          |
| Timer PvP / AFK                        | [DECISION]                               | ⬜         | 60s, config (G7)                                                                                                                                                                                                         |
| Hand limit / luật attack               | [RULE]; hand limit 6 [REF] (thấy 1 lần)  | 🟨         | hand limit: task 1.11 (nháp, PendingPrompt chọn lá bỏ); xem RULES-REVIEW-SHEET; video #2 18:36                                                                                                                           |
...
| Mục                     | Nhãn                                                               | Trạng thái | Ghi chú                                                                                                                                                                                                                                                                                    |
| ----------------------- | ------------------------------------------------------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Duel layout             | [REF] một phần                                                     | 🟨         | video #1 + #2; 1 nút hex 3 trạng thái, 2 ô EX placeholder khóa (C1/C4 [DECISION]). Task 2.7 (nháp): Phaser Duel Scene tĩnh, duyệt bằng `?fixture=midgame\|handfull\|gameover`; bố cục 1280×720 là [GUESS] chưa đối chiếu ảnh gốc, nút hiện là "Phase tiếp theo"/"Kết thúc lượt" (chưa hex) |
...
| Trang debug (công cụ)   | công cụ dev, không thuộc bản gốc                                   | 🟨         | task 2.4 (nháp): `debug.html`, chơi thử luật + soi JSON thô; chờ bạn chơi theo `docs/design/debug-ui.md`                                                                                                                                                                                   |
| AI đối thủ (solo-vs-ai) | [GUESS] (Yugi H5 gốc không có tư liệu về AI; chính sách do AI đặt) | 🟨         | task 2.6 (nháp): AI rule-based đơn giản, chỉ thấy StateView + legalActions; chơi thử theo mục "Chơi thử với AI" ở `docs/design/debug-ui.md`                                                                                                                                                |
