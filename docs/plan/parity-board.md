...
| Attack / damage                        | [RULE]                                   | 🟨         | task 1.6 (nháp); flip-on-attack (quái úp bị đánh) chưa làm, đẩy sau task 1.7 |
| Win / lose + Surrender                 | [RULE]/[DECISION]                        | 🟨         | LP về 0: task 1.7 (nháp); Surrender/hand limit/deck-out chưa làm, G11        |
