...
| Ẩn thông tin theo viewer (StateView)   | [RULE]/thiết kế bảo mật                  | 🟨         | task 2.1 + event-filter + 2.3 (nháp): view/event lọc theo ghế, e2e HTTP 1 ván không lộ; Spell/Trap úp fail-closed `[ASSUMED]`; chưa fuzz |
